...
define('DB_NAME', 'id3ac0rn3r_bangp');

/** MySQL database username */
define('DB_USER', 'id3ac0rn3r_bangp');

/** MySQL database password */
define('DB_PASSWORD', 'p@ssw0rdb@ngpl33');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'lf>5kHhfCuwQ3*|+d|3s}q`h4CL5_uc(uy5twu*C2p|h4Z=MZZ-dQVmj ^n@Nbo(');
define('SECURE_AUTH_KEY',  '-rzL7^c21E}<nSz4`GYiug}7<t:!u*pqf`J!sI$lEa$0ShOCm*k>vw}vP;i1gW;(');
define('LOGGED_IN_KEY',    '$-2 )N+)nO|@{ %jI9)Z(0Bu!D]N[(@q$,jIW1+H/VEBw8J;Q!pS,jn1D;3K,VFB');
define('NONCE_KEY',        '-tA-EDTu#;HC8wR#FGC-g/KbU=hvCCNQaG8.8%G5.H.;aiPzMW@3u3~B?o5H|5|Z');
define('AUTH_SALT',        'SP{EUi,|}Du[]nXDaTC4+d9N6+~FA,FECKSZ?c!u.V_-z6)G~g[JR!Xpfz*VkLGV');
define('SECURE_AUTH_SALT', 'yv0q{:#wWyzk*_xwEz?C,FnYMWh|L$S3dKh4M&31w7@-9,)m56;q=m?ukB~6}?fJ');
define('LOGGED_IN_SALT',   '7GxpUgO*}^ ,k&V*M<e!!Zex8PxUB3MO7-mL#k1%K,cBeL`]d))o5p|yJ}2SI}]f');
define('NONCE_SALT',       'cYI1!ocIIKp/6HJ,}59|%4ih2~.t-9od^WYYDdrN|GPCDeUfRk@|Q+NQXnT//gVv');
