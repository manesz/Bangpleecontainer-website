...
class ImageGallery
{
    ...
    public function loadListImage($galleryID = null)
    {
        if ($galleryID == null) {
            $strSql = "
            SELECT
    ...
    public function addImageGallery($path, $title)
    {
    ...
    public function updateGallery($galleryID, $public)
    {
        $this->wpdb->update(
            'image_gallery',
            array(
        ...
        $imageID = $this->loadListImage($galleryID);
