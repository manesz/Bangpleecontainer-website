...
<footer id="footer">
	<div class="footer-wrap">
		...
		<div class="footer-widgets container half-top">
			...
			<div class="columns one-third first">
				<h4>service</h4>
				<div class="widget-content">
					<!-- <p>
						Mollis malesuada primis in faucibus luctus. Ligula eget dolor.
					</p> -->
					<ul>
						<?php
			...
			<div class="columns one-third">
				...
				<div class="widget-content">
					...
					<ul>
						<?php
						query_posts('category_name="company-group"&order=ASC');
						while (have_posts()) : the_post();	
						?>
						<li>
							<a href="<?php echo get_permalink();?>"><?php the_title();?></a>
			...
			<div class="columns one-third">
				...
				<div class="widget-content">
					...
					<ul class="widget-contact-info">
						<li class="address">
							ที่อยู่: 20/40 หมู่ 17 ต. บางเสาธง อ. บางเสาธง จ. สมุทรปราการ 10540
						</li>
						<li class="phone">
							โทร: 02-3303040,  02-3303611-13 
						</li>
						<li class="">
							Fax: 02-3303076-77 
						</li>
						...
						<li class="mail">
							E-mail: siriwan@bangplee-noi.com
						</li>
					</ul>
				</div>
			</div>
...
<div class="footer-copy">
	<div class="container">
		<p class="align-center">
			&copy; Copyright 2012. Bangpleecontainer co.,Ltd. design by <a href="www.ideacorners.com">IdeaCorners</a>.
		</p>
	</div>
</div>
<!-- End Footer Copy-->
...
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery-ui.custom.min.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.easing.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.flexslider-min.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/camera.min.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.cslider.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.touchSwipe.min.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.caroufredsel.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.isotope.min.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.tipsy.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.zflickrfeed.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.fitvid.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.fancybox.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.timeago.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.tweetable.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.hoverIntent.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/jquery.superfish.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/omnibiz-custom.js"></script>
</body> </html>