...
class VideoGallery
{
    ...
    public function loadListVideo($videoID = null)
    {
        if ($videoID == null) {
            $strSql = "
            SELECT
    ...
    public function addVideo($videoScript, $title)
    {
        $this->wpdb->insert(
            'video_gallery',
            array(
        ...
        $videoID = $this->wpdb->insert_id;
        return $videoID;
    }

    public function updatePublicVideo($videoID, $public)
    {
        $this->wpdb->update(
            'video_gallery',
            array(
    ...
    public function updateVideo($videoID, $videoScript)
    {
        $this->wpdb->update(
            'video_gallery',
            array(
    ...
    public function getVideoID($script)
    {
        ...
        /*
          ...
          */
        return "http://img.youtube.com/vi/$values/mqdefault.jpg";
    }
}