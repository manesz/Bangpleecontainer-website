...
class Mailer
{
    ...
    {
        $this->_mailerHost = 'ssl://smtp.gmail.com';
        $this->_mailerPort = 465;
        $this->_mailerUser = 'manesz13@gmail.com';
        $this->_mailerPass = '$.m@n3sz';
    }
     ...
     * Example:
     * input
     * $subject = 'test email for class';
     *
     * $fromEmail can be use string value like 'newsletter@specialsquare.com'
     ...
     *
     * $message can be use text or html render
     *
     * $partMessage can be use text
     *
