...
<section id="content" class="container add-top">
	<!-- Start Main Content -->
	<div id="primary" class="columns three-fourths first">
		<div class="post-entry">
			...
			<img src="img/photos/photo-5.jpg" alt="Blog Image">
			</div> --><!-- End Post Media -->
	...
	<div id="secondary" class="columns one-fourth">
		<div class="widget">
			...
			<div class="widget-list">
				<ul class="styled-list arrow-6">
					<li>
						<a href="single-blog.html">Penatibus et magnis dis dolor sit amet consectetuer</a>
					</li>
					<li>
						<a href="single-blog.html">Lorem ipsum dolor sit amet</a>
					</li>
					<li>
						<a href="single-blog.html">Aenean commodo ligula eget</a>
					</li>
					<li>
						<a href="single-blog.html">Aenean massa cum sociis</a>
					</li>
					<li>
						<a href="single-blog.html">Penatibus et magnis dis parturient</a>
					</li>
					<li>
						<a href="single-blog.html">Nascetur ridiculus mus dolor sit</a>
					</li>
				</ul>
			</div><!-- End Widget List -->
		</div>
		<div class="widget">
			<div class="widget-tabs">
				<ul class="tabs-head">
					<li>
						<h4><a href="#tabs-recent">Recent</a></h4>
					</li>
					<li>
						<h4><a href="#tabs-popular">Popular</a></h4>
					</li>
					<li>
						<h4><a href="#tabs-comments"><i class="icon-comments-2"></i></a></h4>
					</li>
				</ul>
				<div class="tabs-wrapper">
					<div id="tabs-recent" class="tabs-content">
						<ul class="post-small">
							<li>
								<a href="#"><img src="img/photos/photo-6.jpg" alt="Blog Image"></a>
								<p>
									<a href="#">Morbi tincidunt, dui sit amet facilisis</a>
								</p>
								<span>20 November 2012</span>
							</li>
							<li>
								<a href="#"><img src="img/photos/photo-7.jpg" alt="Blog Image"></a>
								<p>
									<a href="#">Morbi tincidunt, dui sit amet facilisis</a>
								</p>
								<span>20 November 2012</span>
							...
							<li>
								<a href="#"><img src="img/photos/photo-8.jpg" alt="Blog Image"></a>
								<p>
									<a href="#">Morbi tincidunt, dui sit amet facilisis</a>
								</p>
								<span>20 November 2012</span>
		...
		<div class="widget">
			<div class="widget-slide">
				...
				<div class="widget-content">
					<ul class="slides">
						<li><img src="img/works/works-1.jpg" alt="Latest Photo">
						</li>
						<li><img src="img/works/works-2.jpg" alt="Latest Photo">
						</li>
						<li><img src="img/works/works-3.jpg" alt="Latest Photo">
						</li>
						<li><img src="img/works/works-4.jpg" alt="Latest Photo">
						</li>
					</ul>
				</div>
			</div><!-- End Widget Slide -->
		</div>
		<div class="widget">
