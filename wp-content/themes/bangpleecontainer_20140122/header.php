...
/**
 *     Theme Name: Bangplee Container Theme
 *  Theme URI: http://demo.ideacorners.com/business/02/index.html
 *  Description: This theme for business style. Copyright 2012, Wararit Satitnimankan
 *  Version: 1.0
...
<head>
    ...
    <meta name="keywords" content="ขาย เช่า ตู้คอนเทนเนอร์, ขาย เช่า ออฟฟิศสำเร็จรูปเคลื่อนที่, อะไหล่ตู้คอนเทนเนอร์ ส่วนประกอบตู้คอนเทนเนอร์, ไม้อัดพื้นตู้คอนเทนเนอร์, ลูกเต๋าตู้คอนเทนเนอร์,  Corner Casting, ผนังหลังคาตู้คอนเทนเนอร์, รับขนส่งสินค้าระหว่างประเทศ, รับขนส่งตู้คอนเทนเนอร์ ,ประเภทตู้คอนเทนเนอร์บรรจุ ตู้คอนเทนเนอร์สินค้า ตู้คอนเทนเนอร์เปล่า, บริการรถเทรลเลอร์ ขนย้าย, รับฝากตู้คอนเทนเนอร์">


    <script>
<!--        window.jQuery || document.write('<script src="--><?php //echo get_template_directory_uri();?><!--/assets/js/vendor/jquery-1.8.2.min.js"><\/script>')-->
    </script>
    <?php wp_head();?>
    ...
    <!-- Lightbox
   =============================================== -->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/lib/lightbox2/css/lightbox.css">
    <script type="text/javascript" src="<?php echo get_template_directory_uri();?>/lib/lightbox2/js/jquery.smooth-scroll.min.js"></script>
    <script type="text/javascript" src="<?php echo get_template_directory_uri();?>/lib/lightbox2/js/lightbox.js"></script>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/asset/css/plugins.css">
    <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri();?>/asset/css/colors/blue.css"
          media="screen">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/asset/css/responsive.css">
    <!--  WebFont
         =============================================== -->
    <link href="http://fonts.googleapis.com/css?family=Lato:300,400,700,300italic,400italic,700italic|Raleway:600"
          rel="stylesheet" type="text/css">
    <!-- Modernizr
         =============================================== -->
    <script type="text/javascript" src="<?php echo get_template_directory_uri();?>/asset/js/modernizr.js"></script>
	...
	<script>
	  ...
	  ga('create', 'UA-42349353-1', 'bangpleecontainer.com');
	  ga('send', 'pageview');
...
<div id="wrapper">
    ...
    <div class="header-wrapper header-alt2">
        <!-- Start Header -->
        <header id="header" class="half-bottom">
            <!-- Start Logo-->
            <section id="top" class=" container row">
                <!-- Logo -->
                <div class="columns three">
                    <!-- 3 Columns -->
                    <!-- <div>
                                     <H3 style="color: #FFF">บางพลีคอนเทรนเนอร์</H3>
                                     <p style="color: #F6A">ผู้ให้บริการด้านตู้คอนเทรนเนอร์ครบวงจร</p>
                                 </div> -->
                    <div id="logo" style="height: 75px !important;">
                        <img
                            src="http://demo.ideacorners.com/bangpleecontainer/wp-content/themes/bangpleecontainer/asset/img/logo-3.png"/>
                    </div>
                    <div id="logoDesc" style="margin-bottom: -30px;"><p style="color: #FFF">ผู้ให้บริการด้านคอนเทรเนอร์ครบวงจร</p>
                    </div>
                </div>
                <!-- 9 Columns -->
                <div class="columns nine">
                    ...
                    <div class="curved-shadow">
                        ...
                        <nav id="main-nav" class="nav2">
                            <ul class="sf-menu">
                                <li>
                                    <a href="<?php bloginfo('siteurl'); ?>" class="active">Home</a>
                                </li>
                                <li>
                                    <a href="#">Services</a>
                                    <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <?php
                                        query_posts('category_name="job-reference"&order=ASC');
                                        while (have_posts()) : the_post();
                                            ?>
                                            <li style="width: 300px">
                                                <a href="<?php echo get_permalink();?>"><?php the_title();?></a>
                                ...
                                <li>
                                    <a href="<?php echo get_page_link(14);?>">gallery</a>
                                </li>
                                <li>
                                    <a href="<?php echo get_page_link(15);?>">Contact</a>
                                </li>
                            </ul>
                        </nav>
                        <!-- End Main Navigation -->
